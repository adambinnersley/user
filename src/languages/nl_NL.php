...
$lang['reset_requested'] = "De aanvraag voor het herstellen van je wachtwoord is verzonden naar je e-mail adres.";
$lang['reset_requested_emailmessage_suppressed'] = "De aanvraag voor het herstellen van je wachtwoord is aangemaakt.";
$lang['reset_exists'] = "De aanvraag voor het herstellen van je wachtwoord is al gebeurd.";
...
$lang['email_reset_body'] = 'Hallo,<br/><br/>Om je wachtwoord te herstellen, klik deze link:<br/><br/><strong><a href="%1$s/%2$s?key=%3$s">%1$s/%2$s?key=%3$s</a></strong><br/><br/> Als je recent geen herstelsleutel voor je wachtwoord hebt aangevraagd op %1$s, dan is dit bericht foutief verstuurd - gelieve het te negeren.';
$lang['email_reset_altbody'] = 'Hallo, ' . "\n\n" . 'Om je wachtwoord te herstellen, klik deze link:' . "\n" . '%1$s/%2$s?key=%3$s' . "\n\n" . 'Als je recent geen account op %1$s hebt proberen aanmaken, dan is dit bericht foutief verstuurd - gelieve het te negeren.';

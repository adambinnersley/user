...
$lang['email_reset_body'] = 'سلام,<br/><br/>ددې لپاره چي تاسو خپل پټ توري نوي کړئ نو په لاندي پيوند باندي کليک وکړئ:<br/><br/><strong><a href="%1$s/%2$s?key=%3$s">%1$s/%2$s?key=%3$s</a></strong><br/><br/>که تاسو په دې وروستيو کي د %1$s څخه د پټو تورو د نوي کولو غوښتنه نه وي کړې نو لطفاً دا بريښناليک له پامه وغورځوئ.';

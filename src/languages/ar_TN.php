...
$lang['email_reset_body'] = 'مرحبا،<br/><br/>لإعادة تعيين كلمة المرور الخاصة بك انقر على الرابط التالي: <br/><br/><strong><a href="%1$s/%2$s?key=%3$s">%1$s/%2$s?key=%3$s</a></strong><br/><br/>ثم تحتاج إلى استخدام مفتاح إعادة تعيين كلمة المرور التاليةإذا كنت لم تطلب إعادة تعيين كلمة المرور مؤخرا على %1$s ثم أرسلت هذه الرسالة عن طريق الخطأ، الرجاء تجاهله.';
